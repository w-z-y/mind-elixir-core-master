...
import { logHistory, redo, undo } from './undo'
...
function MindElixir(this: MindElixirInstance, {
  ...
  this.currentNodeCache = null // the selected <tpc/> element
...
MindElixir.prototype = {
  ...
  removeNodeSelf: beforeHook(removeNodeSelf),
